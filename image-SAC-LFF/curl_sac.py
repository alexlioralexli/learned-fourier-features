...
def weight_init(m):
    ...
    elif isinstance(m, nn.Conv2d) and m.bias is None:
        pass
...
class Actor(nn.Module):
    ...
    def __init__(
        ...
        encoder_feature_dim, log_std_min, log_std_max, num_layers, num_filters, encoder_kwargs
    ):
        super().__init__()

        self.encoder = make_encoder(
            encoder_type, obs_shape, encoder_feature_dim, num_layers,
            num_filters, output_logits=True, encoder_kwargs=encoder_kwargs
        )
...
class Critic(nn.Module):
    ...
    def __init__(
        self, obs_shape, action_shape, hidden_dim, encoder_type,
        encoder_feature_dim, num_layers, num_filters, encoder_kwargs
    ):
        super().__init__()
...
class RadSacAgent(object):
    ...
    def __init__(
        ...
        self.actor = Actor(
            ...
            num_layers, num_filters, encoder_kwargs
        ).to(device)
        ...
        if self.encoder_type in {'pixel', 'fourier_pixel', 'fair_pixel'}:
